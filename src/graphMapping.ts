...
// ---------------------------------------------------------------------------
// Local mirror of services/knowledge-graph-engine/src/ontology/labels.ts
// ---------------------------------------------------------------------------
 ...
 * than doing that.
 */
export function mapVesselRecordToGraph(record: VesselSanctionRawRecord): VesselGraphMapping {
