 ...
 * applies here.
 */
export declare const OFAC_SDN_XML_URL = "https://sanctionslistservice.ofac.treas.gov/api/PublicationPreview/exports/SDN.XML";
export declare const UN_CONSOLIDATED_XML_URL = "https://scsanctions.un.org/resources/xml/en/consolidated.xml";
export declare const OFAC_DETAILS_BASE_URL = "https://sanctionssearch.ofac.treas.gov/Details.aspx";
/**
